...
echo ""
echo "--- 1. ŚRODOWISKO BASH ---"
echo "AGENTS_DIR:                       $AGENTS_DIR"
echo "PYTHONPATH:                       $PYTHONPATH"
echo "VENV_PYTHON:                      $VENV_PYTHON"

echo ""
echo "--- 2. KATALOGI GŁÓWNE (z config.yaml) ---"
echo "Dysk bazowy (base_path):          $($GET_CONFIG paths.base_path)"
echo "Katalog Agents (base_path_agents):$($GET_CONFIG paths.base_path_agents)"
...
echo "Katalog zbiorów (datasets):       $($GET_CONFIG paths.datasets)"
echo "Katalog modeli (models_dir):      $($GET_CONFIG paths.models_dir)"
echo "Wyjście modeli (models_output):   $($GET_CONFIG paths.models_output_dir)"

echo ""
echo "--- 3. UŻYWANE MODELE ---"
